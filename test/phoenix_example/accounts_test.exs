defmodule PhoenixExample.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{description: "some description", display_name: "some display_name", email: "some email", password_hash: "some password_hash", screen_name: "some screen_name"}
    @update_attrs %{description: "some updated description", display_name: "some updated display_name", email: "some updated email", password_hash: "some updated password_hash", screen_name: "some updated screen_name"}
